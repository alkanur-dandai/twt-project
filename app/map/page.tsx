      ...
      >
        ...
        {hoveredFeature && (
          <MapGeoJSON
            ...
            interactive={false}
            fillPaint={{ "fill-color": "#ffffff", "fill-opacity": 0.25 }}
            linePaint={{ "line-color": "#16a34a", "line-width": 3 }}
          />
        )}
        ...
        {municipalityFeature && (
          <MapGeoJSON
            ...
            interactive={false}
            fillPaint={{ "fill-color": "#2386e3", "fill-opacity": 0.7 }}
            linePaint={{ "line-color": "#f5ecec", "line-width": 1 }}
          />
        )}
